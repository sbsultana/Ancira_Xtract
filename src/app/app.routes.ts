...
export const routes: Routes = [
  ...
  // { path: 'LoanerInventory', loadComponent: () => import('./Reports/Accounting/LoanerInventory/dashboard/dashboard').then(m => m.Dashboard) },
  ...
  { path: 'FleetVehicle', loadComponent: () => import('./Reports/Receivables/FleetVehicleAR/dashboard/dashboard').then(m => m.Dashboard) },
  ...
  { path: 'DealerTradeReceivables', loadComponent: () => import('./Reports/Receivables/Receivables/dashboard/dashboard').then(m => m.Dashboard) },
  { path: 'Employee', loadComponent: () => import('./Reports/Receivables/Receivables/dashboard/dashboard').then(m => m.Dashboard) },
  { path: 'DepositsAR', loadComponent: () => import('./Reports/Receivables/Receivables/dashboard/dashboard').then(m => m.Dashboard) },
  { path: 'BodyShop', loadComponent: () => import('./Reports/Receivables/Receivables/dashboard/dashboard').then(m => m.Dashboard) },
  { path: 'Incentives', loadComponent: () => import('./Reports/Receivables/Receivables/dashboard/dashboard').then(m => m.Dashboard) },
  { path: 'Warranty', loadComponent: () => import('./Reports/Receivables/Receivables/dashboard/dashboard').then(m => m.Dashboard) },
  { path: 'Other', loadComponent: () => import('./Reports/Receivables/Receivables/dashboard/dashboard').then(m => m.Dashboard) },
  ...
  { path: 'FleetTT&L', loadComponent: () => import('./Reports/Liabilities/Liabilities/dashboard/dashboard').then(m => m.Dashboard) },
  ...
  { path: 'UsedFlooring', loadComponent: () => import('./Reports/Liabilities/Liabilities/dashboard/dashboard').then(m => m.Dashboard) },
  { path: 'Sublets', loadComponent: () => import('./Reports/Liabilities/Liabilities/dashboard/dashboard').then(m => m.Dashboard) },
