...
@Component({
  selector: 'app-enterpriseincomebyexpensewithoutoverhead-details',
  standalone: true,
  imports: [NgStyle, SharedModule],
  templateUrl: './enterpriseincomebyexpensewithoutoverhead-details.html',
  styleUrl: './enterpriseincomebyexpensewithoutoverhead-details.scss',
})
export class EnterpriseincomebyexpensewithoutoverheadDetails {
  @Input() DetailsET: any;
  as_id: any = [];
  DetailsETData: any = [];
  pageNumber: any = 1;
  ...
  GetLayerOneDetails() {
    ...
    const Obj = {
      ...
      DATE: this.shared.datePipe.transform(this.DetailsET.LatestDate, 'yyyy-MM') + '-10',
