  ...
  get filteredData() {
    ...
    const filtered = this.filteredFloorplanData.filter((x: any) =>
      searchTerms.some(term =>
        ...
        x.CTAge?.toString().toLowerCase().includes(term) ||
        x.CTDate?.toString().toLowerCase().includes(term) ||
        x.Dealno?.toLowerCase().includes(term) ||
        ...
        x.CustName?.toLowerCase().includes(term) ||
        x.CustId?.toString().toLowerCase().includes(term) ||

        x.SP1_Name?.toString().toLowerCase().includes(term) ||
        x.SalesMgr_Name?.toString().toLowerCase().includes(term) ||

        x.store?.toLowerCase().includes(term) ||

        x.StockNo?.toString().toLowerCase().includes(term) ||
        x.FIMgr_Name?.toString().toLowerCase().includes(term) ||

        x.Stage?.toLowerCase().includes(term) ||
        x.FIMgr_Name?.toLowerCase().includes(term) ||

        x.DealType2?.toLowerCase().includes(term) ||
        ...
        x.Lender?.toLowerCase().includes(term)
